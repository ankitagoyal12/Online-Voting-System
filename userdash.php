            ...
            <ul>
                ...
                <li>
                    <a href="#">
                        ...
                        <span class="title-1"><?php echo $Fname; ?></span>
                    </a>
                ...
                <li>
                    <a href="ballot.php">
                        ...
                        <span class="title">Vote here</span>
                    </a>
                </li>
             ...
             <div class="cardBox">
                ...
                <div class="card">
                    <div>
                        ...
                        <div class="cardName">Check Your Updation!!!</div>
                    </div>
                ...
                <div class="card">
                    <div onclick="gotoresults()">
                        ...
                        <div class="cardName">Check Results!!!</div>
                    </div>
